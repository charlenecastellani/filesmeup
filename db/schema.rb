...
ActiveRecord::Schema.define(version: 2021_03_20_113845) do
  ...
  create_table "requests", force: :cascade do |t|
    ...
    t.string "statut"
    t.string "titre"
    t.bigint "emetteur_id"
    t.bigint "destinataire_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["destinataire_id"], name: "index_requests_on_destinataire_id"
    t.index ["emetteur_id"], name: "index_requests_on_emetteur_id"
  end
