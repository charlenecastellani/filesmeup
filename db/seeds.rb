...
document1 = Document.create(nom: "Comptes annuels 2020", description: "bilan, compte de résultat et detail des comptes", request: audit1, etat_document: "envoyé")
document2 = Document.create(nom: "Texte des résolutions", description: "Juridique d'approbation des comptes 2020", request: audit2, etat_document: "envoyé" )
...
document7 = Document.create(nom: "Relevé bancaire de décembre BNP", description: "Dernier releve bancaire de l'exercice faisant apparaitre le solde au 31/12/2020", request: audit1, etat_document: "envoyé")
...
document10 = Document.create(nom: "Inventaire au 31/12/2020", description: "Inventaire du stock au 31/12/2020 signé par le dirigeant", request: audit1, etat_document: "envoyé")
...
document14 = Document.create(nom: "Balance générale au 31/12/2020", description: "Balance générale à jour suite modif au format excel avec comparatif n-1", request: audit4, etat_document: "envoyé")
